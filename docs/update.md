...
```
go build -ldflags "-X github.com/0x01001011/k10s/internal/version.Version=v1.4.0 \
                   -X github.com/0x01001011/k10s/internal/version.Commit=abc1234 \
                   -X github.com/0x01001011/k10s/internal/version.Date=2026-08-26"
```
